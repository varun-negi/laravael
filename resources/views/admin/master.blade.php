...
<head>
  ...
  <link href="{{asset('public/css/sb-admin-2.min.css')}}" rel="stylesheet">
    <link href="{{asset('public/admin/datatables/dataTables.bootstrap4.min.css')}}" rel="stylesheet">
...
<body id="page-top">
  ...
  <!-- Page level plugins -->
  <script src="{{asset('public/admin/chart.js/Chart.min.js')}}"></script>
  ...
  <script src="{{asset('public/admin/datatables/dataTables.bootstrap4.min.js')}}"></script>
